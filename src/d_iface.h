...
static inline void D_StartParticles (void) {}

void D_DrawParticle (particle_t *pparticle);
/*static inline void D_DrawParticle(particle_t *pparticle) {
    register particle_t *_pparticle __asm("a0") = pparticle;

    __asm("jsr _D_DrawParticle_asm" : : "r" (_pparticle) : "d0", "d1", "d2", "d3", "d4", "d5", "d6", "d7", "a1", "a2", "a3", "a4", "cc", "memory");
}*/

static inline void D_EndParticles (void) {}
