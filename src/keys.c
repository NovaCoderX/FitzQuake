...
keyname_t keynames[] = { { "TAB", K_TAB }, { "ENTER", K_ENTER }, { "ESCAPE", K_ESCAPE }, { "SPACE", K_SPACE }, { "BACKSPACE", K_BACKSPACE },
		...
		//johnfitz -- keypad
		{ "KP_NUMLOCK", KP_NUMLOCK }, { "KP_SLASH", KP_SLASH }, { "KP_STAR", KP_STAR }, { "KP_MINUS", KP_MINUS }, { "KP_HOME", KP_HOME }, {
				"KP_UPARROW", KP_UPARROW }, { "KP_PGUP", KP_PGUP }, { "KP_PLUS", KP_PLUS }, { "KP_LEFTARROW", KP_LEFTARROW },
		{ "KP_5", KP_5 }, { "KP_RIGHTARROW", KP_RIGHTARROW }, { "KP_END", KP_END }, { "KP_DOWNARROW", KP_DOWNARROW },
		{ "KP_PGDN", KP_PGDN }, { "KP_ENTER", KP_ENTER }, { "KP_INS", KP_INS }, { "KP_DEL", KP_DEL },
		//johnfitz
		...
		{ "PGUP", K_PGUP }, { "HOME", K_HOME }, { "END", K_END }, { "MOUSE1", K_MOUSE1 }, { "MOUSE2", K_MOUSE2 }, { "MOUSE3", K_MOUSE3 }, {
				"JOY1", K_JOY1 }, { "JOY2", K_JOY2 }, { "JOY3", K_JOY3 }, { "JOY4", K_JOY4 }, { "AUX1", K_AUX1 }, { "AUX2", K_AUX2 }, {
				"AUX3", K_AUX3 }, { "AUX4", K_AUX4 }, { "AUX5", K_AUX5 }, { "AUX6", K_AUX6 }, { "AUX7", K_AUX7 }, { "AUX8", K_AUX8 }, {
				"AUX9", K_AUX9 }, { "AUX10", K_AUX10 }, { "AUX11", K_AUX11 }, { "AUX12", K_AUX12 }, { "AUX13", K_AUX13 },
		{ "AUX14", K_AUX14 }, { "AUX15", K_AUX15 }, { "AUX16", K_AUX16 }, { "AUX17", K_AUX17 }, { "AUX18", K_AUX18 }, { "AUX19", K_AUX19 },
		{ "AUX20", K_AUX20 }, { "AUX21", K_AUX21 }, { "AUX22", K_AUX22 }, { "AUX23", K_AUX23 }, { "AUX24", K_AUX24 }, { "AUX25", K_AUX25 },
		{ "AUX26", K_AUX26 }, { "AUX27", K_AUX27 }, { "AUX28", K_AUX28 }, { "AUX29", K_AUX29 }, { "AUX30", K_AUX30 }, { "AUX31", K_AUX31 },
		{ "AUX32", K_AUX32 }, { "PAUSE", K_PAUSE }, { "MWHEELUP", K_MWHEELUP }, { "MWHEELDOWN", K_MWHEELDOWN }, { "SEMICOLON", ';' },// because a raw semicolon seperates commands
		{ NULL, 0 } };
...
/*
 ...
 ===================
 */
static void ProcessEvent(int key, qboolean down) {
	char* kb;
	char cmd[1024];
...
void Key_Event(SDL_KeyboardEvent* event) {
	int key = key_map[event->keysym.sym];
	if (key) {
		ProcessEvent(key, (event->type == SDL_KEYDOWN));
	}
}

void Button_Event(SDL_MouseButtonEvent* event) {
	switch (event->button) {
	case SDL_BUTTON_LEFT:
		ProcessEvent(K_MOUSE1, (event->state == SDL_PRESSED));
		break;
	case SDL_BUTTON_MIDDLE:
		ProcessEvent(K_MOUSE2, (event->state == SDL_PRESSED));
		break;
	case SDL_BUTTON_RIGHT:
		ProcessEvent(K_MOUSE3, (event->state == SDL_PRESSED));
		break;
	case SDL_BUTTON_WHEELUP:
		ProcessEvent(K_MWHEELUP, (event->state == SDL_PRESSED));
		break;
	case SDL_BUTTON_WHEELDOWN:
		ProcessEvent(K_MWHEELDOWN, (event->state == SDL_PRESSED));
		break;
	}
}
